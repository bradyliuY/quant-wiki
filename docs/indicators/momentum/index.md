...
动量指标回答"走势有多强"。度量涨跌的动能与速度，用来捕捉超买超卖、背离与短期转折。

| 指标 | 难度 | 一句话 |
|------|------|--------|
| [RSI](./rsi) | <span class="dlv dlv-intermediate">进阶</span> | 涨跌的"力气"还剩多少，超买超卖 + 背离 |
...
- [趋势指标](../trend/)：先定方向，再用动量找入场点
- [成交量指标](../volume/)：量价结合确认动能
