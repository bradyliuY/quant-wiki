...
| [动量指标](../indicators/momentum/) | 走势有多强？ | RSI、KD、CCI、%R | 找超买超卖、找背离 |
| [波动率指标](../indicators/volatility/) | 波动有多剧烈？ | 布林带、ATR、肯特纳 | 设止损、定仓位 |
| [成交量指标](../indicators/volume/) | 谁在推动价格？ | OBV、MFI、成交量分布 | 确认量价配合 |
